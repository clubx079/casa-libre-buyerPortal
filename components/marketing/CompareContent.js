  ...
  const t = es
    ? {
        ...
        rows: [
          ...
          ['Contacto directo con quien publica', 'Sí, sea inmobiliaria o dueño', 'A veces sólo por formulario'],
        ],
    ...
    : {
        ...
        rows: [
          ...
          ['Direct contact with whoever listed it', 'Yes — agency or owner', 'Sometimes form-only'],
        ],
