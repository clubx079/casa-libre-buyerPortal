...
// Referential FX-rate note for a small footnote near converted prices.
// `rate` = guaraníes per USD. Rounded to the nearest 50 Gs for a clean read.
export function fmtRate(rate, lang) {
  ...
  return lang === 'en'
    ? `Reference rate: US$ 1 ≈ ${gs}. Converted amounts are approximate.`
    : `Cotización referencial: US$ 1 ≈ ${gs}. Los montos convertidos son aproximados.`;
}
