...
const PROFILES = {
  ...
  ve: {
    ...
    desc: 'Casa Libre es el marketplace de propiedades en Venezuela. Compra, alquila y publica casas, apartamentos, terrenos y locales en Caracas, Valencia, Maracaibo y todo el país — gratis.',
