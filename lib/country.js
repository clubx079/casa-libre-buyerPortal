...
const PROFILES = {
  ...
  py: {
    ...
    desc: 'Casa Libre reúne todas las propiedades de Paraguay en una sola app: de inmobiliarias y de dueños particulares. Comprá, alquilá o publicá casas, departamentos, dúplex y locales en Asunción y todo el país, sin comisión.',
  ...
  bo: {
    ...
    desc: 'Casa Libre reúne todas las propiedades de Bolivia en una sola app: de inmobiliarias y de dueños particulares. Comprá, alquilá o publicá casas, departamentos, dúplex y locales en Santa Cruz y todo el país, sin comisión.',
  ...
  uy: {
    ...
    desc: 'Casa Libre reúne todas las propiedades de Uruguay en una sola app: de inmobiliarias y de dueños particulares. Comprá, alquilá o publicá casas, departamentos, dúplex y locales en Montevideo y todo el país, sin comisión.',
  ...
  ve: {
    ...
    desc: 'Casa Libre reúne todas las propiedades de Venezuela en una sola app: de inmobiliarias y de dueños particulares. Compra, alquila o publica casas, apartamentos, terrenos y locales en Caracas, Valencia, Maracaibo y todo el país, sin comisión.',
