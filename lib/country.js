...
const PROFILES = {
  ...
  bo: {
    ...
    fxTarget: 'BOB',
    fxFallback: 6.96,                            // 🚩 BOB pegged ≈ 6.96/USD
    fxSource: 'open.er-api.com',
...
// Build-time country selection. NEXT_PUBLIC_COUNTRY is inlined into both bundles;
// COUNTRY is a server-only fallback. Defaults to Paraguay so nothing changes.
const CODE = String(
  process.env.NEXT_PUBLIC_COUNTRY || process.env.COUNTRY || 'py'
).toLowerCase();
