...
// presented as approximations that the reader must confirm with their escribano.
// Have an escribanía verify them once and the hedging can be replaced by exact
...
export const GUIDES = [
  {
    ...
    description: `Cómo vender una casa en ${c}: preparar la propiedad, ponerle precio, publicarla gratis, mostrarla, negociar la seña y firmar la escritura ante escribano.`,
    answer: `Para vender tu casa en ${c} necesitás cuatro cosas: el título de propiedad en regla, un precio de referencia basado en propiedades parecidas de tu zona, un aviso con fotos reales y ubicación en el mapa, y un escribano para la escritura. Publicar el aviso es gratis y podés hacerlo vos mismo; la transferencia siempre se firma ante escribano público.`,
    sections: [
      ...
      { h2: 'Mostrar la propiedad y negociar', paras: [
        ...
        'Cuando llega una oferta, lo habitual es firmar un acuerdo de compraventa con una seña, que reserva la propiedad y fija plazo, forma de pago y qué pasa si una de las partes se arrepiente. Ese documento conviene que lo redacte un escribano o un abogado, aunque la firma final sea más adelante.',
      ] },
      { h2: 'La escritura', paras: [
        'La transferencia se hace por escritura pública ante escribano. El escribano verifica el título, pide los certificados registrales, catastrales y municipales, redacta la escritura, toma las firmas e inscribe la transferencia en el Registro.',
    ...
    faq: [
      { q: '¿Puedo vender mi casa sin inmobiliaria?', a: 'Sí. Podés publicar el aviso, mostrar la propiedad y negociar vos mismo. Lo que no podés evitar es el escribano: la transferencia de un inmueble se hace siempre por escritura pública.' },
      { q: '¿Cuánto tarda vender una casa?', a: 'Depende del precio y de la zona. Lo que sí es previsible es el tramo final: desde que hay acuerdo hasta la firma suelen pasar entre 30 y 60 días por los certificados que pide el escribano.' },
      { q: '¿Qué gastos paga el vendedor?', a: 'Normalmente una parte de la escritura y los impuestos que correspondan a la venta. Los porcentajes cambian según el caso; confirmalos con tu escribano antes de acordar el precio final.' },
  ...
  },
  {
    ...
    description: `Qué paga el vendedor de un inmueble en ${c}: honorarios del escribano, inscripción registral, impuesto municipal de transferencia e impuestos sobre la venta.`,
    answer: `Al vender un inmueble en ${c} los costos habituales son los honorarios del escribano, la tasa de inscripción en el Registro, el impuesto municipal de transferencia y los impuestos que gravan la operación. En la práctica comprador y vendedor suelen repartirse la escritura, y el total ronda un porcentaje bajo de un dígito sobre el valor de venta. Los porcentajes exactos dependen del monto y del caso: confirmalos con tu escribano.`,
    sections: [
      { h2: 'Qué se paga en una venta', paras: [
        'Conviene separar tres cosas: los honorarios profesionales (escribano), las tasas del Estado (inscripción registral, impuesto municipal de transferencia) y los impuestos que gravan la ganancia o la operación.',
      ], table: {
        head: ['Concepto', 'Quién lo paga habitualmente', 'Orden de magnitud'],
        rows: [
          ['Honorarios del escribano', 'Suele repartirse entre comprador y vendedor', 'Un porcentaje del valor, decreciente según el monto'],
      ...
      { h2: 'Por qué no hay un número único', paras: [
        'Los honorarios de escribanía se calculan por escalas: cuanto mayor el valor de la propiedad, menor el porcentaje. Las tasas municipales cambian según dónde esté el inmueble. Y la carga impositiva depende de si quien vende es una persona física o una empresa, y de cómo se computa la operación.',
        'Por eso la única cifra confiable es un presupuesto. Pedilo a dos o tres escribanías antes de cerrar el precio: los honorarios son negociables y la diferencia entre presupuestos suele ser real.',
      ] },
    ...
    faq: [
      ...
      { q: '¿Cuánto cobra un escribano?', a: 'Por escalas: el porcentaje baja a medida que sube el valor de la propiedad, más el IVA correspondiente. Pedí presupuesto a dos o tres escribanías y compará.' },
      { q: '¿Se puede vender con deudas de impuesto inmobiliario?', a: 'El escribano va a exigir los certificados al día antes de escriturar, así que en la práctica las deudas se cancelan durante el proceso, normalmente descontándolas del precio.' },
    ],
  ...
  },
  {
    ...
    answer: 'Podés vender por tu cuenta: publicar el aviso, atender consultas, mostrar la propiedad y acordar el precio. Lo que no cambia es que la transferencia se firma ante escribano, y que conviene que el acuerdo de seña lo redacte un profesional. La inmobiliaria aporta difusión, filtro de interesados y manejo de la negociación, y cobra comisión por eso.',
    sections: [
      ...
      { h2: 'Lo que conviene delegar', bullets: [
        ...
        'La verificación del título y los certificados: eso lo hace el escribano.',
      ...
      { h2: 'Cuidados prácticos', paras: [
        ...
        'Si alguien te ofrece pagar por adelantado con condiciones raras, o insiste en firmar fuera de escribanía, frená. La estafa habitual en venta particular no es sofisticada: se apoya en el apuro.',
    ...
    faq: [
      { q: '¿Es legal vender sin inmobiliaria?', a: 'Sí. No hay obligación de intermediar; la operación se formaliza ante escribano igual que cualquier otra.' },
  ...
  },
  {
    ...
    answer: 'Para vender necesitás el título de propiedad inscripto a tu nombre, tu documento de identidad, los datos catastrales del inmueble y los certificados y comprobantes que pide el escribano: situación registral, deudas de impuesto inmobiliario y servicios al día. Si la propiedad está en sucesión, tiene varios titulares o una hipoteca vigente, eso se resuelve antes de escriturar.',
    sections: [
      ...
      { h2: 'Lo que pide el escribano', paras: [
        'El escribano solicita los certificados registrales y municipales que acreditan que el inmueble está libre de embargos, hipotecas u otras restricciones, y que los datos coinciden con el Registro. Ese trámite es el que marca el plazo real hasta la firma.',
      ] },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: '¿El contrato tiene que hacerse ante escribano?', a: 'No es obligatorio para alquilar, pero un contrato escrito y firmado por ambas partes es imprescindible. Para plazos largos o montos altos, la certificación de firmas da respaldo.' },
  ...
  },
  {
    ...
    description: `Qué se paga además del precio al comprar un inmueble en ${c}: escribanía, inscripción registral, impuesto de transferencia, certificados y gastos de crédito.`,
    answer: `Además del precio, comprar un inmueble en ${c} suma escribanía, inscripción en el Registro, el impuesto municipal de transferencia y los certificados previos. En conjunto conviene presupuestar un porcentaje adicional sobre el valor de la propiedad, y bastante más si comprás con crédito hipotecario. Pedí presupuesto a tu escribano antes de firmar la seña.`,
    sections: [
      { h2: 'Qué se suma al precio', table: {
        head: ['Concepto', 'Quién lo paga habitualmente', 'Comentario'],
        rows: [
          ['Honorarios de escribanía', 'Suele repartirse', 'Escalas decrecientes según el valor'],
          ...
          ['Certificados previos', 'Vendedor, en general', 'Los tramita el escribano'],
      ...
      { h2: 'Cómo evitar sorpresas', bullets: [
        'Pedí presupuesto de escribanía antes de firmar la seña, no después.',
    ...
    faq: [
      { q: '¿Cuánto hay que presupuestar además del precio?', a: 'Depende del valor y de si hay crédito. Pedí presupuesto de escribanía y sumá inscripción e impuesto de transferencia; con esos tres números tenés el total real.' },
      { q: '¿Puede un extranjero comprar propiedad?', a: 'En general sí, con requisitos que dependen del país y de la ubicación del inmueble. Consultalo con tu escribano antes de señar.' },
  ...
  },
  {
    ...
    answer: 'Comprar tu primera casa son cinco pasos: definir cuánto podés pagar sumando los gastos de escrituración, buscar por zona en el mapa, visitar con una lista de control, verificar el título con un escribano antes de señar, y firmar la escritura. El orden importa: la verificación va antes de la seña, no después.',
    sections: [
      ...
      { h2: '4. Verificá antes de señar', paras: [
        'Antes de entregar dinero, pedí a un escribano que revise el título, la matrícula y la situación registral. Es la única forma de saber si hay embargos, hipotecas o diferencias entre lo registrado y lo construido. Señar primero y verificar después es el error caro.',
      ] },
      { h2: '5. Seña, escritura y entrega', paras: [
        'El acuerdo de compraventa con seña fija precio, plazo y condiciones. Después el escribano reúne los certificados, redacta la escritura y se firma. La entrega de llaves se pacta en el mismo documento: dejalo explícito.',
      ] },
    ],
    faq: [
